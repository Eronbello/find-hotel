...
describe('HotelCard', () => {
  ...
  describe('Components', () => {
    describe('when component is loaded', () => {
      ...
      it('should have a tui-hotel-card__stars', () => {
        expect(wrapper.find('.tui-hotel-card__stars').exists()).toBeTruthy()
      })
      it('should have a tui-hotel-card__details', () => {
        expect(wrapper.find('.tui-hotel-card__details').exists()).toBeTruthy()
      })
      it('should have a tui-hotel-card__place', () => {
        expect(wrapper.find('.tui-hotel-card__place').exists()).toBeTruthy()
      })
    })
  })
  describe('Behaviour', () => {
